...
def create_data_part(opt):
    ...
    test_csv_path = os.path.join(opt["path_to_save_csv"], "val.csv")
    train_ds = PARADataset(train_csv_path, opt["path_to_images"], if_train=True)
    test_ds = PARADataset(test_csv_path, opt["path_to_images"], if_train=False)
