...
def init():
    ...
    parser.add_argument("--path_to_images", type=str, default="/home/xiaoyi/datasets/ICAA17K", help="directory to images")
    parser.add_argument("--path_to_save_csv", type=str, default="./ICAA17K_csv", help="directory to csv_folder")
    parser.add_argument("--experiment_dir_name", type=str, default=f"./experiment/DAT+_ICAA_time{time.time():.2f}", help="directory to project")
    parser.add_argument(
